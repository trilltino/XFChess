...
fn complete_swiss_tournament_ix(cranker: Pubkey) -> Instruction {
    let accounts = xfchess_game::__client_accounts_complete_swiss_tournament::CompleteSwissTournament {
...
async fn setup(current_round: u8, p1: Pubkey, p2: Pubkey, p3: Pubkey, p4: Pubkey) -> ProgramTestContext {
