...
| File | Contents |
|------|----------|
| [delegation.rs](delegation.rs) | `delegate_game_pda` (wraps `ephemeral_rollups_sdk::cpi::delegate_account`), `commit_and_undelegate_game_pda` (wraps `ephem::MagicIntentBundleBuilder`) |
