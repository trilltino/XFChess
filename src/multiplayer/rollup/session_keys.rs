...
impl HandshakeOrderingKeyManager {
    ...
    fn load_keypair_from_disk(&self) -> Result<Keypair, SessionKeyError> {
        ...
        Keypair::try_from(array.as_slice())
            .map_err(|e| SessionKeyError::InvalidKeypair(e.to_string()))
    }
...
mod tests {
    ...
    fn test_different_game_ids() {
        ...
        let path1 = manager1
            .get_key_path()
            .expect("should have valid path for manager1");
        let path2 = manager2
            .get_key_path()
            .expect("should have valid path for manager2");
