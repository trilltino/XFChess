...
use pointer_events::*;
mod egui_ui;
use crate::{board_events::BoardEventsPlugin, egui_ui::playgame_ui, state_manager::LaunchMenu, state_manager::GameState};
use board_utils::*;
use egui_ui::UIPlugin;
mod board_events;
mod board_utils;
mod launchmenu;
mod launchui;
...
fn main() {
    ...
    App::new()
        ...
        .add_systems(EguiContextPass, playgame_ui)
        ...
        //ToDo - add seperate all functions into Startup, Update or FixedUpdate
        //Create OnEnter for Launchmenu
        //Finnish LaunchMenu UI,
        //
