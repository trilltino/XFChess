     ...
     use bevy::time::Time;
     use crate::board_utils::{PieceMaterials,ReturnEntityMaterials};
       ...
       #[derive(Resource,Debug)]
        ...
        impl FromWorld for Timer {
            fn from_world(world: &mut World) -> Self {
                ...
                pub fn update_on<E>(
                    new_material: &Res<'_,PieceMaterials>,
                    ) -> impl Fn(Trigger<E>, Query<&PieceMaterials>) {
                    move |trigger, mut query| {
                        for mut entity in query.iter_mut(){
                            new_material = entity.hover_entmatl.clone();
                        }
                        }
                    }
                ...
                pub fn revert_on<E>(
                    new_material: &Res<'_,ReturnEntityMaterials>,
                    ) -> impl Fn(Trigger<E>, Query<&PieceMaterials>) {
                    move |trigger, mut query| {
