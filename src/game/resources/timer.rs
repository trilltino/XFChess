...
mod tests {
    ...
    fn test_game_timer_default() {
        ...
        assert_eq!(timer.white_time_left, 600.0, "White should start with 10 minutes (600 seconds)");
        assert_eq!(timer.black_time_left, 600.0, "Black should start with 10 minutes (600 seconds)");
    ...
    fn test_apply_increment_white() {
        ...
        assert_eq!(timer.black_time_left, 300.0, "Black's time should not change");
    }
    ...
    fn test_apply_increment_black() {
        ...
        assert_eq!(timer.white_time_left, 300.0, "White's time should not change");
    ...
    fn test_apply_increment_zero() {
        ...
        assert_eq!(timer.white_time_left, 300.0, "Time should not change with 0 increment");
        assert_eq!(timer.black_time_left, 300.0, "Time should not change with 0 increment");
    }
    ...
    fn test_apply_increment_multiple_moves() {
        ...
        assert_eq!(timer.white_time_left, 109.0, "White should have 3 increments (100 + 9)");
        assert_eq!(timer.black_time_left, 109.0, "Black should have 3 increments (100 + 9)");
    }
    ...
    fn test_fischer_prevents_timeout() {
        ...
        assert_eq!(timer.white_time_left, 6.0, "Increment should save player from timeout");
    }
}
