...
const OPERA_GAME_MOVES: &[(&str, &str, &str)] = &[
    ...
    ("e1c1", "Queenside castling - Rook enters d-file with tempo", "rnb1k2r/pp1qppp1/3p4/1p1P3/4P3/1QN5/PPP2PPP/RNBQKB1R b KQkq - 1 10"),
    ("a8d8", "Rook to d8 - Defends against discovered attack", "r2b1k2r/pp1qppp1/3p4/1p1P3/4P3/1QN5/PPP2PPP/RNBQKB1R w KQkq - 2 11"),
    ("d1d7", "Rook sacrifice! Rxd7 - Morphy's brilliance begins", "r2b1k2r/pp1qppp1/3p4/1p1P3/4P3/1QN5/PPP2PPP/RNBQKB1R b KQkq - 2 11"),
