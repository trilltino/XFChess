...
import { Mt as init_ed25519, St as init_index_browser_esm, j as PublicKey, jt as ed25519, v as Keypair } from "./index.browser.esm-DWU1tjbw.js";
import { C as WalletNotConnectedError, E as WalletSendTransactionError, O as WalletSignMessageError, S as WalletLoadError, T as WalletPublicKeyError, _ as WalletConnectionError, b as WalletError, c as BaseSignInMessageSignerWalletAdapter, f as WalletReadyState, g as WalletConfigError, h as WalletAccountError, k as WalletSignTransactionError, l as BaseSignerWalletAdapter, m as scopePollingDetectionStrategy, p as isIosAndRedirectable, s as BaseMessageSignerWalletAdapter, t as WalletAdapterNetwork, u as isVersionedTransaction, v as WalletDisconnectedError, w as WalletNotReadyError, y as WalletDisconnectionError } from "./esm-CMMVjH_r.js";
import { t as createSignInMessage } from "./signIn-BbiJwYFt.js";
import { t as esm_default } from "./esm-DPAiLcWa.js";
import { n as WalletConnectWalletName, t as WalletConnectWalletAdapter } from "./esm-CMXoD23w.js";
import { a as StatusCodes, c as TransportStatusError } from "./Transport-CHLhLzka.js";
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			try {
				FractalWalletClass = (await import("./esm-Cg2EL_Cp.js")).FractalWalletAdapterImpl;
			} catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let keyring;
			try {
				const { DefaultKeyring } = await import("./dist-hqOapLvL.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function send(transport, instruction, p1, data) {
	...
	if (data.length > MAX_PAYLOAD) while (data.length - offset > MAX_PAYLOAD) {
		...
		if ((await transport.send(LEDGER_CLA, instruction, p1, p2 | P2_MORE, buffer)).length !== 2) throw new TransportStatusError(StatusCodes.INCORRECT_DATA);
		p2 |= P2_EXTEND;
		offset += MAX_PAYLOAD;
	}
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			try {
				TransportWebHIDClass = (await import("./TransportWebHID-rl5Leo5m.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let transport;
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let WalletClass;
			try {
				({ParticleNetwork: ParticleClass, SolanaWallet: WalletClass} = await import("./es-y5Quloub.js"));
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SalmonClass;
			try {
				SalmonClass = (await import("./esm-CDcU7YVO.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SolflareClass;
			try {
				SolflareClass = (await import("./esm-CW4M4zKY.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let TorusClass;
			try {
				TorusClass = (await import("./solanaEmbed.esm-C3ONBncB.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let wallet;
			try {
				const { default: TrezorConnect } = await import("./lib-OtKXNPMK.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
