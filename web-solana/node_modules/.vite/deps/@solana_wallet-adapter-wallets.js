...
import { Mt as ed25519, Nt as init_ed25519, St as init_index_browser_esm, j as PublicKey, v as Keypair } from "./index.browser.esm-CJ1w-M3H.js";
...
import { t as createSignInMessage } from "./signIn-68K4WPuI.js";
import { t as esm_default } from "./esm-CYGZHuzy.js";
import { a as StatusCodes, c as TransportStatusError } from "./Transport-CmMEh9ej.js";
import { n as WalletConnectWalletName, t as WalletConnectWalletAdapter } from "./esm-B_lPkiy0.js";
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			try {
				FractalWalletClass = (await import("./esm-CgD1GI0Q.js")).FractalWalletAdapterImpl;
			} catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let keyring;
			try {
				const { DefaultKeyring } = await import("./dist-rTSYW_vo.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			try {
				TransportWebHIDClass = (await import("./TransportWebHID-bGSbMNPU.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let transport;
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let WalletClass;
			try {
				({ParticleNetwork: ParticleClass, SolanaWallet: WalletClass} = await import("./es--qkvdVQv.js"));
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SalmonClass;
			try {
				SalmonClass = (await import("./esm-DCd91lZ7.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SolflareClass;
			try {
				SolflareClass = (await import("./esm-BSbqqvcV.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let TorusClass;
			try {
				TorusClass = (await import("./solanaEmbed.esm-Cvg3GdBi.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let wallet;
			try {
				const { default: TrezorConnect } = await import("./lib-bKFLgQaM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
