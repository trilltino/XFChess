...
import { Mt as init_ed25519, St as init_index_browser_esm, j as PublicKey, jt as ed25519, v as Keypair } from "./index.browser.esm-B3Kc8vn4.js";
...
import { t as createSignInMessage } from "./signIn-Dc0Bb36r.js";
import { t as esm_default } from "./esm-fslCKLQz.js";
import { n as WalletConnectWalletName, t as WalletConnectWalletAdapter } from "./esm-DRb-tYgp.js";
import { a as StatusCodes, c as TransportStatusError } from "./Transport-C5J-YGls.js";
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			try {
				FractalWalletClass = (await import("./esm-D-VYtPZK.js")).FractalWalletAdapterImpl;
			} catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let keyring;
			try {
				const { DefaultKeyring } = await import("./dist-DvF_B02Q.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			try {
				TransportWebHIDClass = (await import("./TransportWebHID-B7IOugxE.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let transport;
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let WalletClass;
			try {
				({ParticleNetwork: ParticleClass, SolanaWallet: WalletClass} = await import("./es-DymzlmGs.js"));
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SalmonClass;
			try {
				SalmonClass = (await import("./esm-DffUHQ4M.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SolflareClass;
			try {
				SolflareClass = (await import("./esm-BSIWNTDO.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let TorusClass;
			try {
				TorusClass = (await import("./solanaEmbed.esm-SrWx9vrV.js")).default;
			} catch (error) {
				throw new WalletLoadError(error?.message, error);
			}
			let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let wallet;
			try {
				const { default: TrezorConnect } = await import("./lib-PD4Le52S.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
