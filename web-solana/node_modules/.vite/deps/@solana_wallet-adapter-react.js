...
import { St as init_index_browser_esm, j as PublicKey, mt as VersionedTransaction, nt as Transaction, p as Connection } from "./index.browser.esm-CJ1w-M3H.js";
import { C as WalletNotConnectedError, D as WalletSignInError, E as WalletSendTransactionError, O as WalletSignMessageError, T as WalletPublicKeyError, _ as WalletConnectionError, a as SolanaSignTransaction, b as WalletError, d as BaseWalletAdapter, f as WalletReadyState, g as WalletConfigError, h as WalletAccountError, i as StandardConnect, k as WalletSignTransactionError, n as isWalletAdapterCompatibleStandardWallet, o as SolanaSignAndSendTransaction, r as StandardEvents, u as isVersionedTransaction, v as WalletDisconnectedError, w as WalletNotReadyError, y as WalletDisconnectionError } from "./esm-5g3qYllx.js";
import { a as SolanaMobileWalletAdapterWalletName, c as createDefaultWalletNotFoundHandler, d as SOLANA_MAINNET_CHAIN, f as SOLANA_TESTNET_CHAIN, h as SolanaSignIn, l as SOLANA_DEVNET_CHAIN, m as SolanaSignMessage, o as createDefaultAddressSelector, p as StandardDisconnect, r as SolanaMobileWalletAdapter, s as createDefaultAuthorizationResultCache, u as SOLANA_LOCALNET_CHAIN } from "./index.browser-BmPvED54.js";
import { t as esm_default } from "./esm-CYGZHuzy.js";
...
//#endregion
//#region node_modules/@solana/wallet-adapter-react/lib/esm/useAnchorWallet.js
function useAnchorWallet() {
	const { publicKey, signTransaction, signAllTransactions } = useWallet();
	return (0, import_react.useMemo)(() => publicKey && signTransaction && signAllTransactions ? {
		publicKey,
		signTransaction,
		signAllTransactions
	} : void 0, [
...
//#endregion
//#region node_modules/@solana/wallet-standard-wallet-adapter-react/node_modules/@solana/wallet-standard-wallet-adapter-base/lib/esm/adapter.js
init_index_browser_esm();
...
var StandardWalletAdapter = class extends BaseWalletAdapter {
	...
	constructor({ wallet }) {
		...
		_StandardWalletAdapter_changed.set(this, (properties) => {
			if ("accounts" in properties) {
				...
				if (__classPrivateFieldGet(this, _StandardWalletAdapter_account, "f") && !__classPrivateFieldGet(this, _StandardWalletAdapter_disconnecting, "f") && account !== __classPrivateFieldGet(this, _StandardWalletAdapter_account, "f")) if (account) __classPrivateFieldGet(this, _StandardWalletAdapter_instances, "m", _StandardWalletAdapter_connected).call(this, account);
				else {
	...
	async sendTransaction(transaction, connection, options = {}) {
		try {
			...
			let feature;
			if ("solana:signAndSendTransaction" in __classPrivateFieldGet(this, _StandardWalletAdapter_wallet, "f").features) if (account.features.includes("solana:signAndSendTransaction")) feature = SolanaSignAndSendTransaction;
...
//#endregion
//#region node_modules/@solana/wallet-standard-wallet-adapter-react/node_modules/@solana/wallet-standard-wallet-adapter-base/lib/esm/types.js
/**
...
function WalletProviderBase({ children, wallets: adapters, adapter, isUnloadingRef, onAutoConnectRequest, onConnectError, onError, onSelectWallet }) {
	...
	*/
	...
	const handleErrorRef = (0, import_react.useRef)((error, adapter) => {
		if (!isUnloadingRef.current) if (onErrorRef.current) onErrorRef.current(error, adapter);
		else {
...
function WalletProvider({ children, wallets: adapters, autoConnect, localStorageKey = "walletName", onError }) {
	...
	const handleAutoConnectRequest = (0, import_react.useMemo)(() => {
		...
		return async () => {
			if (autoConnect === true || await autoConnect(adapter)) if (hasUserSelectedAWallet.current) await adapter.connect();
...
//#endregion
export { ConnectionContext, ConnectionProvider, WalletContext, WalletNotSelectedError, WalletProvider, useAnchorWallet, useConnection, useLocalStorage, useWallet };
