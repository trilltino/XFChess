...
param(
    ...
    [string]$User    = "root",
    [string]$Domain  = "xfchess.com",   # Real domain for Let's Encrypt (pass -Domain "" explicitly to force self-signed)
...
if ($serverHasEnv) {
    ...
    Write-Host "  TLS_DOMAIN=${TlsDomain}   # read by GET /admin/tls/expiry"
...
Write-Host "Secrets rotation: See ops/SECRETS_ROTATION.md" -ForegroundColor DarkGray
