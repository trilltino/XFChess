...
```powershell
powershell -ExecutionPolicy Bypass -File ops\rollback.ps1 -Server 178.104.55.19 -User root
```
...
```powershell
powershell -ExecutionPolicy Bypass -File ops\rollback.ps1 -Server 178.104.55.19 -User root -RestoreDb
```
