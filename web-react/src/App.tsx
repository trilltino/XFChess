...
import TournamentDemoPage from './pages/TournamentDemo';
        ...
        <div className="nav-demo-dropdown">
          ...
          {isDemoDropdownOpen && (
            <div className="nav-demo-dropdown-menu">
              ...
              <Link to="/demo/tournament" className="nav-demo-dropdown-item" onClick={() => setIsDemoDropdownOpen(false)}>
                Tournament
              </Link>
            </div>
          )}
      ...
      <main>
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/demo/tournament" element={<TournamentDemoPage />} />
          </Routes>
        </AnimatePresence>
      </main>
