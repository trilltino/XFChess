...
pub const WK4: usize = 4; // e1
pub const BK60: usize = 60; // e8
...
pub const SETUP: [i8; 64] = [
    W_ROOK, W_KNIGHT, W_BISHOP, W_QUEEN, W_KING, W_BISHOP, W_KNIGHT, W_ROOK, W_PAWN, W_PAWN,
    ...
    B_PAWN, B_PAWN, B_ROOK, B_KNIGHT, B_BISHOP, B_QUEEN, B_KING, B_BISHOP, B_KNIGHT, B_ROOK,
];
...
// Unit tests: each new_game() would allocate ~2.2 GB at 2M entries × 1120 bytes/entry.
// Use a minimal table so the whole test suite fits in a normal machine's RAM.
#[cfg(all(not(target_arch = "wasm32"), test))]
pub const TTE_SIZE: usize = 16; // 16 entries (~17 KB) — correctness tests don't need search
