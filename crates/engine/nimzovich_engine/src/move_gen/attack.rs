...
/// Check if the king of a given color is in check
///
/// Uses fast bitboard-based check detection.
pub fn is_in_check(game: &Game, color: Color) -> bool {
    use crate::on_chain::OnChainGame;
    use crate::on_chain_attack::is_in_check_fast;

    // Minimal OnChainGame for check detection (only bitboards and board needed)
    let oc_game = OnChainGame {
        board: game.board,
        white_pawns: game.white_pawns.0,
        white_knights: game.white_knights.0,
        white_bishops: game.white_bishops.0,
        white_rooks: game.white_rooks.0,
        white_queens: game.white_queens.0,
        white_kings: game.white_kings.0,
        black_pawns: game.black_pawns.0,
        black_knights: game.black_knights.0,
        black_bishops: game.black_bishops.0,
        black_rooks: game.black_rooks.0,
        black_queens: game.black_queens.0,
        black_kings: game.black_kings.0,
        occupied_white: game.occupied_white.0,
        occupied_black: game.occupied_black.0,
        occupied: game.occupied.0,
        castling: 0,
        ep_target: -1,
        side_to_move: color as i8,
    };

    is_in_check_fast(&oc_game, color as i8)
}
