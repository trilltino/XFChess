...
- [deploy/docs/ROLLBACK_GUIDE.md](../../deploy/docs/ROLLBACK_GUIDE.md) -
  rollback mechanics.
- [deploy/SECRETS_ROTATION.md](../../deploy/SECRETS_ROTATION.md) - secret
  rotation.
...
- `deploy/SECRETS_ROTATION.md` has been executed for all compromised or uncertain
  secrets.
...
- `deploy/monitoring/grafana/dashboards/xfchess.json`
- `deploy/README.md`
...
- `deploy/nginx/xfchess_rate_limit.conf`
...
5. Fix any doc links that point at moved or missing deploy/monitoring paths.
